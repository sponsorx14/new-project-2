(function (t) {
  function a(a) { for (var n, o, r = a[0], c = a[1], l = a[2], A = 0, p = []; A < r.length; A++)o = r[A], s[o] && p.push(s[o][0]), s[o] = 0; for (n in c)Object.prototype.hasOwnProperty.call(c, n) && (t[n] = c[n]); u && u(a); while (p.length)p.shift()(); return i.push(...l || []), e(); } function e() { for (var t, a = 0; a < i.length; a++) { for (var e = i[a], n = !0, r = 1; r < e.length; r++) { const c = e[r]; s[c] !== 0 && (n = !1); }n && (i.splice(a--, 1), t = o(o.s = e[0])); } return t; } var n = {},
    s = { app: 0 },
  ...
  '56d7': function (t, a, e) {
    e.r(a); e('cadf'), e('551c'), e('097d'); let n = e('2b0e'),
      ...
      l = (e('5c0b'), e('2877')),
      u = {},
      A = Object(l.a)(u, r, c, !1, null, null, null); A.options.__file = 'App.vue'; let p = A.exports,
      m = e('8c4f'),
      f = function () {
        let t = this,
          a = t.$createElement,
      ...
      v = [],
      g = { name: 'Main', data() { return { section: 0 }; }, methods: {} },
      _ = g,
      j = (e('f87b'), Object(l.a)(_, b, v, !1, null, 'afe65176', null)); j.options.__file = 'Main.vue'; let w = j.exports,
      C = function () {
        let t = this,
          a = t.$createElement,
      ...
      y = k,
      z = (e('892d'), Object(l.a)(y, C, h, !1, null, '2b150a26', null)); z.options.__file = 'Header.vue'; let S = z.exports,
      D = function () {
        let t = this,
          a = t.$createElement,
          e = t._self._c || a; return e('section', { staticClass: 'tabs container' }, [t._m(0), t._m(1), e('footer', { staticClass: 'tabs--switch' }, [e('div', { staticClass: 'tabs--switch--select' }, [e('button', { staticClass: 'tabs--switch--select__button', class: { 'active-tab': t.tabName === 'estate' }, on: { click(a) { t.selectTab('estate'); } } }, [t._v('\n\n        Plan osiedla\n      ')]), e('button', { staticClass: 'tabs--switch--select__button', class: { 'active-tab': t.tabName === 'houses' }, on: { click(a) { t.selectTab('houses'); } } }, [t._v('\n\n        Plany domów\n      ')])]), e('transition', { attrs: { name: 'fade', mode: 'out-in' } }, [t.tabName === 'estate' ? e('appTabEstate') : t._e(), t.tabName === 'houses' ? e('appTabHouses') : t._e()], 1)], 1)]);
      },
      x = [function () {
        let t = this,
          a = t.$createElement,
      ...
      E = { name: 'Tab-estate' },
      T = E,
      O = (e('8057'), Object(l.a)(T, P, I, !1, null, '6badc4bc', null)); O.options.__file = 'Tab-estate.vue'; let J = O.exports,
      M = function () {
        let t = this,
          a = t.$createElement,
      ...
      K = { name: 'Tab-houses', computed: { groundFloorInformation() { return this.$store.state.groundFloorInformation; }, atticInformation() { return this.$store.state.atticInformation; } } },
      V = K,
      Y = (e('a95e'), Object(l.a)(V, M, N, !1, null, 'ebc89d40', null)); Y.options.__file = 'Tab-houses.vue'; let G = Y.exports,
      F = {
        name: 'Tabs', components: { appTabEstate: J, appTabHouses: G }, data() { return { tabName: 'estate' }; }, methods: { selectTab(t) { this.tabName = t; } },
      },
      W = F,
      L = (e('8f97'), Object(l.a)(W, D, x, !1, null, '65f2b80a', null)); L.options.__file = 'Tabs.vue'; let R = L.exports,
      H = function () {
        let t = this,
          a = t.$createElement; t._self._c; return t._m(0);
      },
      ...
      B = { name: 'Map' },
      U = B,
      X = (e('d95f'), Object(l.a)(U, H, Q, !1, null, '69606bc7', null)); X.options.__file = 'Map.vue'; let Z = X.exports,
      q = function () {
        let t = this,
          a = t.$createElement; t._self._c; return t._m(0);
      },
      $ = [function () {
        let t = this,
          a = t.$createElement,
          n = t._self._c || a; return n('section', { staticClass: 'attributes section' }, [n('div', { staticClass: 'container' }, [n('header', { staticClass: 'attributes--heading' }, [n('img', { attrs: { src: e('9e1a'), alt: '' } }), n('h2', { staticClass: 'section--title' }, [t._v('Zalety')])]), n('p', [t._v('Osiedle Parkowe to:')]), n('main', { staticClass: 'attributes--wrapper' }, [n('div', { staticClass: 'attrubites--element' }, [n('img', { attrs: { src: '', alt: '' } }), n('h3'), n('p')])])])]);
      }],
      tt = { name: 'Attributes' },
      at = tt,
      et = (e('416e'), Object(l.a)(at, q, $, !1, null, '338b57da', null)); et.options.__file = 'Attributes.vue'; let nt = et.exports,
      st = function () {
        let t = this,
          a = t.$createElement,
      ...
      pt = { name: 'Prices' },
      mt = pt,
      ft = (e('de1c'), Object(l.a)(mt, ut, At, !1, null, '06ecd99b', null)); ft.options.__file = 'Prices.vue'; let dt = ft.exports,
      bt = function () {
        let t = this,
          a = t.$createElement,
      ...
      gt = { name: 'Contact' },
      _t = gt,
      jt = (e('208a'), Object(l.a)(_t, bt, vt, !1, null, '54458cba', null)); jt.options.__file = 'Contact.vue'; let wt = jt.exports,
      Ct = function () {
        let t = this,
          a = t.$createElement,
...
// # sourceMappingURL=app.2d9e1a16.js.map
